...
const AdminSettings = () => {
  const tabItems = [
      ...
      children: (
        <Card style={{ borderRadius: 12 }}>
          <Form layout="vertical" size="large" initialValues={{
            store_name: 'Hypermarket', email: 'support@hypermarket.com', phone: '+91 98765 43210',
            address: '123, MG Road, Koramangala', city: 'Bangalore', state: 'Karnataka', pincode: '560034',
          }}>
            <Row gutter={16}>
    ...
    },
    {
      ...
      children: (
        <Card style={{ borderRadius: 12 }}>
          <Form layout="vertical" size="large" initialValues={{ min_order: 200, free_delivery: 500, delivery_charge: 40, delivery_radius: 10 }}>
            <Row gutter={16}>
    ...
    },
    {
      ...
      children: (
        <Card style={{ borderRadius: 12 }}>
          <Form layout="vertical" size="large" initialValues={{ default_tax: 5, invoice_prefix: 'INV' }}>
            <Row gutter={16}>
              ...
              <Col span={8}><Form.Item name="financial_year" label="Financial Year"><Select options={[{ value: '2025-26', label: '2025-26' }, { value: '2026-27', label: '2026-27' }]} /></Form.Item></Col>
            </Row>
