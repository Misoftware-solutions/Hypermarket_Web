...
const AdminCustomers = () => {
  ...
  const columns = [{
    ...
    render: name => <div className="d-flex align-items-center gap-3">
          <Avatar style={{
        background: '#1890ff'
      }} icon={<UserOutlined />} />
    ...
    title: 'Actions',
    render: (_, r) => <Button type="link" icon={<EyeOutlined />} onClick={() => setDetail(r)}>View</Button>
  }];
  return <div>
      ...
      padding: 0
        ...
        <Table columns={columns} dataSource={customers.map(c => ({
        ...c,
        key: c.customer_id
