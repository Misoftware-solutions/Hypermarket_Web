...
const AdminBrands = () => {
  ...
  return <div>
      ...
      <Modal title="Add Brand" open={isModalOpen} onCancel={() => { setIsModalOpen(false); form.resetFields(); }} onOk={handleCreate}>
        <Form form={form} layout="vertical">
          <Form.Item
            name="brand_name"
            label="Brand Name"
            tooltip="Name of the brand or manufacturer (e.g. Farm Fresh, Tropicana)"
